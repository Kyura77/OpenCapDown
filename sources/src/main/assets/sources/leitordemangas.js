export default {
  ...
  search: function(query) {
    ...
    var items = SourceEnv.queryAll(html, "#loop-content > .page-listing-item, .c-tabs-item__content, .c-tabs-item, .item-summary");
  ...
  getMangaDetail: function(url) {
    ...
    var cover = "";
    var coverEl = SourceEnv.queryAll(html, ".summary_image img, .thumb img");
